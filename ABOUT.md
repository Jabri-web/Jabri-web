...
Z(x) = x**5 * log(x) * sin(2*pi/x) * exp(-x/x_p)
...
**كيف تضيفه:**
1. اضغط القلم ✏️ على `ABOUT.md`
2. انزل تحت آخر شي بعد البادجات 
3. الصق الكود اللي فوق
4. Commit changes

**النتيجة:** 
بيطلع لك قسم المعادلات بكود مرتب + الصورة لو عندك `Image/Zx_Equations.png` في الريبو.

ركز على اختباراتك الحين P8، GitHub ينتظر. خلص وارجع نكمل الباقي
